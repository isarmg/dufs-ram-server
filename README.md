...
- Foundation 认证使用 Core/Static/Axum/Auth 与当前合同；Rust 固定正式 0.7.6 和完整 revision `89eafaf171e409e6134fa669b140f615635baf5a`，Web 固定同版 Release tarball 与锁文件 integrity，不依赖相邻工作区。Dufs 0.51.4 已按当前 Foundation 供应链重新验收；禁止复制平台实现或使用可变分支作为发布来源；
