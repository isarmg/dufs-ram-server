...
for (const name of ["admin-web", "admin-shell", "admin-ui", "contracts", "http-client", "design-tokens", "web-fonts", "web-toolchain"]) {
  ...
  const url = `https://github.com/isarmg/sarmg-foundation-server/releases/download/v0.7.3/sarmg-${name}-0.7.3.tgz`;
...
console.log("Foundation 0.7.3 immutable React Web, shared appearance and font integrity verified");
