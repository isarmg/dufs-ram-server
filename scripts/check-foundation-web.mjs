...
for (const name of ["admin-web", "admin-shell", "admin-ui", "contracts", "http-client", "design-tokens", "web-fonts", "web-toolchain"]) {
  ...
  const url = `https://github.com/isarmg/sarmg-foundation-server/releases/download/v0.9.2/sarmg-${name}-0.9.2.tgz`;
...
console.log("Foundation 0.9.2 immutable React Web and compact font bootstrap verified");
